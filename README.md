...
This repository contains a simple garage door prototype I developed to learn hardware-software communication using Flutter and Arduino. 
...
* **Hardware:** Arduino UNO R4, a Servo Motor to simulate the door mechanism, and status LEDs.
